...
print("Presiona 'u' para marcar posición ARRIBA")
print("Presiona 'd' para marcar posición ABAJO")
...
while True:
    ...
    cv2.imshow('Recolección de datos - Zancadas', cv2.cvtColor(image, cv2.COLOR_RGB2BGR))
...
df.to_csv('lunges_data.csv', index=False)
